...
async def xtest_x_forwarded_strict_no_proto(test_client):
    async def handler(request):
        assert request.host == 'example.com'
        assert request.scheme == 'http'
        assert request.remote == '10.10.10.10'
...
async def xtest_x_forwarded_strict_no_host(test_client):
    async def handler(request):
...
async def xtest_x_forwarded_strict_too_many_headers(test_client):
    async def handler(request):
        assert request.host == 'example.com'
        assert request.scheme == 'https'
        assert request.secure
...
async def xtest_x_forwarded_strict_too_many_protos(test_client):
    async def handler(request):
        return web.Response()
...
async def xtest_x_forwarded_strict_too_many_for(test_client):
    async def handler(request):
        return web.Response()
...
async def xtest_x_forwarded_strict_untrusted_ip(test_client):
    async def handler(request):
        return web.Response()
...
async def xtest_x_forwarded_strict_whitelist(test_client):
    async def handler(request):
        assert request.remote == '127.0.0.1'
        return web.Response()
